  ...
  const renderIllustration = () => {
    switch (category.id) {
        ...
        return (
          <SvgWrapper>
            ...
            <g className="drop-shadow-md">
              <circle cx="145" cy="145" r="28" fill="#ffffff" stroke="#ef4444" strokeWidth="6" />
              <text x="145" y="145" dominantBaseline="central" textAnchor="middle" fill="#000000" className="font-sans font-black text-2xl">50</text>
            </g>
          </SvgWrapper>
        );
        ...
        return (
          <SvgWrapper>
            ...
            <g transform="translate(45, 68)">
              <motion.g animate={enableAnimations ? { x: [0, 5, 0] } : {}} transition={{ repeat: Infinity, duration: 1.2, ease: "easeInOut" }}>
            ...
            <g transform="translate(95, 88)">
              <motion.g animate={enableAnimations ? { x: [0, 4, 0], y: [0, -2, 0] } : {}} transition={{ repeat: Infinity, duration: 1.2, ease: "easeInOut", delay: 0.2 }}>
      ...
      case "jelzesek":
        return (
          <SvgWrapper>
            <rect x="95" y="20" width="10" height="170" fill="#64748b" />
            <rect x="75" y="20" width="50" height="110" fill="#1e293b" rx="10" stroke="#475569" strokeWidth="3" />
            <circle cx="100" cy="42" r="14" fill="#ef4444" />
        ...
        return (
          <SvgWrapper>
            ...
            <g transform="translate(68, 100)">
              <motion.g animate={enableAnimations ? { y: [0, -3, 0], scale: [1, 1.02, 1] } : {}} transition={{ repeat: Infinity, duration: 1.5, ease: "easeInOut" }}>
      ...
      case "lathatosag":
        return (
          <SvgWrapper>
            ...
            {enableAnimations && (
              <motion.g animate={{ opacity: [0.3, 1, 0.3], scale: [0.8, 1.2, 0.8] }} transition={{ repeat: Infinity, duration: 1.5 }} style={{ transformOrigin: "100px 100px" }}>
        ...
        return (
          <SvgWrapper>
            ...
            <g transform="translate(10, 80)">
              <motion.g animate={enableAnimations ? { x: [-20, 15, -20] } : {}} transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }}>
            ...
            <g transform="translate(130, 60)">
              ...
              <motion.g animate={enableAnimations ? { rotate: [0, -60, 0] } : {}} transition={{ repeat: Infinity, duration: 6, ease: "easeInOut" }} style={{ transformOrigin: "25px 50px" }}>
      ...
      case "kultura":
        return (
          <SvgWrapper>
            <motion.path d="M 100 80 Q 75 35 50 60 T 100 135 T 150 60 Q 125 35 100 80 Z" fill="#f472b6" opacity="0.3" animate={enableAnimations ? { scale: [1, 1.05, 1] } : {}} transition={{ repeat: Infinity, duration: 2 }} style={{ transformOrigin: "100px 80px" }} />
            <g transform="translate(15, 80)">
              <rect x="10" y="15" width="45" height="16" fill="#ef4444" rx="4" />
              <path d="M 18 15 L 23 5 L 38 5 L 43 15 Z" fill="#ffffff" />
              <circle cx="20" cy="31" r="5" fill="#1e293b" />
              <circle cx="45" cy="31" r="5" fill="#1e293b" />
            </g>
            <g transform="translate(125, 80)">
              <rect x="10" y="15" width="45" height="16" fill="#3b82f6" rx="4" />
              <path d="M 18 15 L 23 5 L 38 5 L 43 15 Z" fill="#ffffff" />
              <circle cx="20" cy="31" r="5" fill="#1e293b" />
              <circle cx="45" cy="31" r="5" fill="#1e293b" />
            </g>
            <g transform="translate(85, 55)">
              <motion.g animate={enableAnimations ? { rotate: [-10, 15, -10, 15, -10] } : {}} transition={{ repeat: Infinity, duration: 2.2 }} style={{ transformOrigin: "15px 35px" }}>
