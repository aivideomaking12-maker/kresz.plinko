...
export default function CategoryIntro({ category, onComplete, enableAnimations }: CategoryIntroProps) {
  ...
  const renderIllustration = () => {
    switch (category.id) {
      case "sebesség":
        return (
          <svg viewBox="0 0 200 200" className="w-48 h-48 sm:w-56 sm:h-56 mx-auto drop-shadow-xl">
            {/* Speedometer Gauges */}
            ...
            <g transform="translate(110, 110)" className="drop-shadow-md">
              ...
              <text x="35" y="42" textAnchor="middle" fill="#000000" className="font-sans font-black text-2xl">50</text>
            </g>
          </svg>
        );
      ...
      case "kerekpar":
        return (
          <svg viewBox="0 0 200 200" className="w-48 h-48 sm:w-56 sm:h-56 mx-auto drop-shadow-xl">
            {/* Wheels */}
            <motion.g animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 2, ease: "linear" }} style={{ transformOrigin: "50px 120px" }}>
            ...
            <motion.g animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 2, ease: "linear" }} style={{ transformOrigin: "150px 120px" }}>
            ...
            {/* Rear stays of the Frame */}
            <path d="M 50 120 L 85 80 M 50 120 L 95 120" stroke="#10b981" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
            
            {/* Frame Main Triangle */}
            <polygon points="95,120 130,75 85,80" stroke="#10b981" strokeWidth="5" strokeLinejoin="round" fill="none" />
            
            {/* Fork and Handlebar stem */}
            <path d="M 150 120 L 130 75 L 128 62" stroke="#475569" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
      ...
      case "gyalogos":
        return (
          <svg viewBox="0 0 200 200" className="w-48 h-48 sm:w-56 sm:h-56 mx-auto drop-shadow-xl">
            ...
            {/* Pedestrians (Cartoon walking children) */}
            <motion.g
              animate={{ x: [0, 4, 0] }}
      ...
      case "jelzesek":
        return (
          <svg viewBox="0 0 200 200" className="w-48 h-48 sm:w-56 sm:h-56 mx-auto drop-shadow-xl">
            ...
            {/* Red Light glow */}
            <circle cx="100" cy="42" r="14" fill="#ff8787" opacity="0.4" className="animate-pulse" />

            <circle cx="100" cy="77" r="14" fill="#fbbf24" />
            <circle cx="100" cy="112" r="14" fill="#22c55e" />
            <circle cx="100" cy="112" r="14" fill="#86efac" opacity="0.4" className="animate-pulse" />
          </svg>
        );
        ...
        return (
          <svg viewBox="0 0 200 200" className="w-48 h-48 sm:w-56 sm:h-56 mx-auto drop-shadow-xl">
            ...
            <g transform="translate(45, 60)" className="drop-shadow-md">
              ...
              <text x="20" y="25" textAnchor="middle" fill="#ffffff" className="font-sans font-black text-[10px] tracking-wider">STOP</text>
            </g>

            {/* Priority Main Road Sign (Főútvonal) on the right */}
        ...
        return (
          <svg viewBox="0 0 200 200" className="w-48 h-48 sm:w-56 sm:h-56 mx-auto drop-shadow-xl">
            ...
            <g transform="translate(110, 50)" className="drop-shadow-md">
              ...
              <text x="25" y="32" textAnchor="middle" fill="#ffffff" className="font-sans font-black text-3xl">P</text>
            </g>
          </svg>
        );
      ...
      case "haladas":
        return (
          <svg viewBox="0 0 200 200" className="w-48 h-48 sm:w-56 sm:h-56 mx-auto drop-shadow-xl">
            {/* Winding road leading into horizon */}
            ...
            {/* Cute Cartoon Police car driving */}
            <motion.g
            ...
            >
              ...
              <circle cx="32" cy="4" r="1" fill="#ffffff" className="animate-ping" />
            </motion.g>
          </svg>
        );
        ...
        return (
          <svg viewBox="0 0 200 200" className="w-48 h-48 sm:w-56 sm:h-56 mx-auto drop-shadow-xl">
            ...
            <g transform="translate(45, 30)">
              ...
              {/* V-neck cut */}
              <path d="M 40 17 L 55 50 L 70 17 Z" fill="#60a5fa" /> {/* under-shirt blue color */}
      ...
      case "vasut":
        return (
          <svg viewBox="0 0 200 200" className="w-48 h-48 sm:w-56 sm:h-56 mx-auto drop-shadow-xl">
            ...
            >
              <rect x="35" y="15" width="50" height="35" fill="#dc2626" rx="3" />
              <rect x="55" y="2" width="25" height="15" fill="#1e293b" />
              <rect x="15" y="25" width="20" height="25" fill="#334155" />
              {/* Train wheels */}
              <circle cx="30" cy="50" r="8" fill="#0f172a" />
              <circle cx="50" cy="50" r="8" fill="#0f172a" />
              <circle cx="70" cy="50" r="8" fill="#0f172a" />
              {/* Window */}
              <rect x="60" y="20" width="15" height="12" fill="#bae6fd" />
            </motion.g>

            {/* Railway Gate (Flashing Crossing) */}
            <g transform="translate(130, 60)" className="drop-shadow-md">
              ...
              <circle cx="25" cy="27" r="5" fill="#e2e8f0" /> {/* white center flash */}
      ...
      case "kultura":
        return (
          <svg viewBox="0 0 200 200" className="w-48 h-48 sm:w-56 sm:h-56 mx-auto drop-shadow-xl">
            {/* Big Heart in background representing courtesy and friendship */}
            <motion.path
            ...
            {/* Smiling blue car on the right letting it pass */}
            ...
            {/* Waving Hand of courtesy in center */}
            <motion.g
              animate={{ rotate: [-10, 15, -10, 15, -10] }}
              transition={{ repeat: Infinity, duration: 2.2 }}
              transform="translate(85, 55)"
              style={{ transformOrigin: "15px 35px" }}
            >
              {/* Hand vector with fill="none" to prevent black filling */}
