...
export default function PlinkoBoard({
  ...
  useEffect(() => {
    ...
    // Koordináták konvertálása SVG koordinátákba
    ...
    // Ellenőrizzük, hogy a korong közelében kattintottunk-e (pl. 40px sugarú körön belül)
    const dist = Math.sqrt(Math.pow(x - discPos.x, 2) + Math.pow(y - discPos.y, 2));
    
    if (dist < 40) { // Csak akkor fogadjuk el a drag-et, ha a korongra kattintott
      setIsDragging(true);
